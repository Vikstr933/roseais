...
import { User, Lock, Building, CreditCard, Settings as SettingsIcon, Key, Plug } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-20 sm:pt-24 pb-6 sm:pb-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
          <TabsList className="grid w-full grid-cols-4 sm:grid-cols-8 lg:w-auto lg:inline-grid overflow-x-auto">
            ...
            <TabsTrigger value="connectors" className="gap-1 sm:gap-2 min-h-[44px] sm:min-h-0 text-xs sm:text-sm">
              <Plug className="h-4 w-4 flex-shrink-0" />
              <span className="hidden sm:inline">Connectors</span>
            </TabsTrigger>
            <TabsTrigger value="api-keys" className="gap-1 sm:gap-2 min-h-[44px] sm:min-h-0 text-xs sm:text-sm">
