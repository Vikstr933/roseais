        ...
        <div className="prose prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Integration with third-party services (Discord, GitHub, etc.)</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mt-8 mb-4">7. API Keys and Third-Party Services</h2>
            <p>
          ...
          <section>
            ...
            <p className="mt-4">
              <strong>Email:</strong> support@ailibrary.com<br />
