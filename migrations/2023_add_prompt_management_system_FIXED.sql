-- Migration: Add Prompt Management System (FIXED VERSION)
-- This enables dynamic prompt management, versioning, and A/B testing
-- Created: 2025-11-03
-- Fixed: Removed problematic foreign key constraints for compatibility
...
CREATE TABLE IF NOT EXISTS prompt_templates (
  ...
  min_user_tier VARCHAR(20) DEFAULT 'free',
...
CREATE INDEX IF NOT EXISTS idx_prompt_templates_key_status ON prompt_templates(prompt_key, status);
CREATE INDEX IF NOT EXISTS idx_prompt_templates_agent_type ON prompt_templates(agent_type);
CREATE INDEX IF NOT EXISTS idx_prompt_templates_default ON prompt_templates(prompt_key) WHERE is_default = true;
CREATE INDEX IF NOT EXISTS idx_prompt_templates_experiment ON prompt_templates(experiment_id) WHERE experiment_id IS NOT NULL;
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_prompt_usage_logs_template ON prompt_usage_logs(prompt_template_id);
CREATE INDEX IF NOT EXISTS idx_prompt_usage_logs_created_at ON prompt_usage_logs(created_at);
CREATE INDEX IF NOT EXISTS idx_prompt_usage_logs_agent_type ON prompt_usage_logs(agent_type);
...
CREATE TABLE IF NOT EXISTS coding_guidelines (
  ...
  applies_to VARCHAR[] DEFAULT ARRAY['*'],
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_coding_guidelines_category ON coding_guidelines(category);
CREATE INDEX IF NOT EXISTS idx_coding_guidelines_enabled ON coding_guidelines(enabled) WHERE enabled = true;

-- ============================================================================
-- SEED DATA: Insert coding guidelines
-- ============================================================================
...
-- ============================================================================
-- SEED DATA: Insert PluginGeneratorAgent prompts
-- ============================================================================
