...
exports.selectPromptChainSchema = exports.insertPromptChainSchema = exports.selectPromptTemplateSchema = exports.insertPromptTemplateSchema = exports.selectAgentSchema = exports.insertAgentSchema = exports.promptChainsRelations = exports.promptTemplatesRelations = exports.chainExecutions = exports.promptChains = exports.promptTemplates = exports.selectOrchestrationPatternSchema = exports.insertOrchestrationPatternSchema = exports.selectAgentScriptSchema = exports.insertAgentScriptSchema = exports.agents = exports.orchestrationPatterns = exports.agentScripts = exports.workspaces = exports.frameworks = exports.companies = exports.aiModels = void 0;
...
exports.orchestrationPatterns = (0, pg_core_1.pgTable)("orchestration_patterns", {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    name: (0, pg_core_1.text)("name").notNull(),
    description: (0, pg_core_1.text)("description").notNull(),
...
exports.insertAgentScriptSchema = (0, drizzle_zod_1.createInsertSchema)(exports.agentScripts);
exports.selectAgentScriptSchema = (0, drizzle_zod_1.createSelectSchema)(exports.agentScripts);
exports.insertOrchestrationPatternSchema = (0, drizzle_zod_1.createInsertSchema)(exports.orchestrationPatterns);
exports.selectOrchestrationPatternSchema = (0, drizzle_zod_1.createSelectSchema)(exports.orchestrationPatterns);
...
exports.chainExecutions = (0, pg_core_1.pgTable)("chain_executions", {
    ...
    chainId: (0, pg_core_1.integer)("chain_id").notNull().references(function () { return exports.promptChains.id; }),
    ...
    agentId: (0, pg_core_1.integer)("agent_id").references(function () { return exports.agents.id; }),
});
exports.promptTemplatesRelations = (0, drizzle_orm_1.relations)(exports.promptTemplates, function (_a) {
    var many = _a.many;
    return ({
        chains: many(exports.promptChains),
    });
});
exports.promptChainsRelations = (0, drizzle_orm_1.relations)(exports.promptChains, function (_a) {
...
exports.insertAgentSchema = (0, drizzle_zod_1.createInsertSchema)(exports.agents);
exports.selectAgentSchema = (0, drizzle_zod_1.createSelectSchema)(exports.agents);
exports.insertPromptTemplateSchema = (0, drizzle_zod_1.createInsertSchema)(exports.promptTemplates);
exports.selectPromptTemplateSchema = (0, drizzle_zod_1.createSelectSchema)(exports.promptTemplates);
exports.insertPromptChainSchema = (0, drizzle_zod_1.createInsertSchema)(exports.promptChains);
exports.selectPromptChainSchema = (0, drizzle_zod_1.createSelectSchema)(exports.promptChains);
