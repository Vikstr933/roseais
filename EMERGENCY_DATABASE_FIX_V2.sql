-- ============================================================
-- EMERGENCY DATABASE FIX V2 - FIXED VERSION
-- ============================================================
...
-- Update any NULL values (FIXED - no reference to non-existent 'name' column)
UPDATE users SET updated_at = CURRENT_TIMESTAMP WHERE updated_at IS NULL;
UPDATE users SET created_at = CURRENT_TIMESTAMP WHERE created_at IS NULL;
UPDATE users SET username = email WHERE username IS NULL;
UPDATE users SET display_name = email WHERE display_name IS NULL;  -- FIXED: Use email instead of name
