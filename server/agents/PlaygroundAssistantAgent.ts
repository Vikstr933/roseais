...
3. **Multi-Language Support**: The system can generate code in various languages - React/TypeScript, Python, Node.js, etc. Note: The live preview only works for web apps (React/Vite), but users can generate any type of code.
...
- If a user asks what languages you support: you can generate any code, but preview/deployment is optimized for web apps (React/TypeScript)
