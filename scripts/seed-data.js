  ...
  try {
    ...
    const agentsData = [
      {
        ...
        system_prompt:
          'You are a senior frontend developer specializing in React, Vue, and modern web technologies. You create clean, maintainable, and performant user interfaces.',
        temperature: '0.7',
      ...
      },
      {
        ...
        description:
          'Expert in Node.js, Python, databases, and API development',
        role: 'backend',
        model: 'claude-3-5-sonnet-20241022',
        system_prompt:
          'You are a senior backend developer specializing in Node.js, Python, and database design. You create scalable, secure, and efficient APIs.',
        temperature: '0.7',
        capabilities: JSON.stringify([
          'API Development',
          'Database Design',
      ...
      },
      {
        ...
        description:
          'Expert in database architecture, optimization, and data modeling',
        role: 'database',
        model: 'claude-3-5-sonnet-20241022',
        system_prompt:
          'You are a senior database architect specializing in PostgreSQL, MySQL, and data modeling. You design efficient, scalable database schemas.',
        temperature: '0.6',
        capabilities: JSON.stringify([
          'Schema Design',
          'Query Optimization',
    ...
    const scriptsData = [
      ...
      },
      {
        ...
        description:
          'Generates RESTful API endpoints with proper error handling and validation',
        language: 'TypeScript',
        version: '1.0.0',
        script_template:
    ...
    const scriptCount = db
      .prepare('SELECT COUNT(*) as count FROM agent_scripts')
      .get();

    console.log(
      `📊 Database seeded with ${agentCount.count} agents and ${scriptCount.count} scripts`
    );
