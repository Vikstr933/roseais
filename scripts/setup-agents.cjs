...
const agents = [
  {
    ...
    role: 'App Architect',
    description: 'Specializes in designing component architecture and structure',
    model: 'sonnet-20241022',
    system_prompt: 'You are an expert React component architect. Analyze requirements and design robust, scalable component architectures.',
    is_active: true,
    temperature: '0.7',
    capabilities: {
  ...
  },
  {
    ...
    model: 'sonnet-20241022',
    system_prompt: 'You are an expert React developer. Implement components following best practices and design patterns.',
    is_active: true,
    temperature: '0.7',
    capabilities: {
  ...
  },
  {
    ...
    model: 'sonnet-20241022',
    system_prompt: 'You are an expert QA engineer. Test React components thoroughly and provide detailed test results.',
    is_active: true,
    temperature: '0.7',
    capabilities: {
      testing: true,
...
setupAgents().catch(console.error).finally(() => pool.end());
