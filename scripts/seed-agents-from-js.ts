    ...
    const agentsData = [
      {
        ...
        description:
          'Expert in React, Vue, Angular, and modern frontend technologies with responsive design and performance optimization',
        role: 'frontend',
...
7. Follow best practices for performance optimization`,
        ...
        frameworks: ['React', 'Next.js', 'Vue', 'Angular', 'Nuxt.js', 'Svelte'],
        libraries: [
          'React Router',
          'Redux',
          'Zustand',
      ...
      },
      {
        ...
        description:
          'Expert in Node.js, Python, databases, and API development with microservices architecture',
        role: 'backend',
        model: 'claude-3-5-sonnet-20241022',
...
7. Use modern async/await patterns`,
      ...
      },
      {
        ...
        description:
          'Specializes in database architecture, schema design, optimization, and data modeling',
        role: 'database',
        model: 'claude-3-5-sonnet-20241022',
...
7. Document all design decisions`,
      ...
      },
      {
        ...
        description:
          'Expert in Python ecosystem, frameworks, data science, and automation',
        role: 'python',
        model: 'claude-3-5-sonnet-20241022',
...
7. Include proper documentation`,
      ...
      },
      {
        name: 'C++ Developer',
        description:
          'Expert in modern C++, performance optimization, and system programming',
        role: 'cpp',
        model: 'claude-3-5-sonnet-20241022',
...
7. Follow platform-specific best practices`,
        ...
        frameworks: ['Qt', 'Boost', 'OpenGL', 'Vulkan', 'SDL', 'SFML'],
        libraries: [
      ...
      },
      {
        name: 'PHP Developer',
        description:
          'Expert in Laravel, Symfony, WordPress, and modern PHP development',
        role: 'php',
        model: 'claude-3-5-sonnet-20241022',
...
7. Include proper documentation`,
      ...
      },
      {
        ...
        description:
          'Coordinates development teams and manages project lifecycles with deadline enforcement',
...
7. Ensure quality standards are met`,
        ...
        frameworks: ['Agile', 'Scrum', 'Kanban', 'Waterfall', 'Hybrid', 'SAFe'],
        libraries: [
          'Jira',
          'Trello',
          'Asana',
      ...
      },
      {
        ...
        description:
          'Ensures code quality, testing strategies, and quality gates for project delivery',
...
7. Document testing procedures and results`,
      ...
      },
      {
        ...
        description:
          'Monitors project progress, tracks completion metrics, and provides progress insights',
...
7. Maintain transparency with stakeholders`,
      ...
      },
      {
        ...
        description:
          'Enforces project deadlines, manages timeline pressure, and ensures on-time delivery',
...
8. Guarantee project completion`,
      ...
      },
      {
        ...
        description:
          'Specializes in The Forgotten Server, MMORPG development, and game mechanics',
        role: 'tfs',
        model: 'claude-3-5-sonnet-20241022',
