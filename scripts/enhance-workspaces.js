...
const enhancedWorkspacesData = [
  {
    ...
    description: "Automated code review system using multiple AI agents for comprehensive analysis, security scanning, and performance optimization",
    ...
    testCases: JSON.stringify([
      {
        ...
        expectedOutput: "Should identify SQL injection, XSS, and authentication bypass vulnerabilities"
      },
      {
        name: "Performance Analysis",
        input: "Analyze database query performance in this React component",
        expectedOutput: "Should suggest query optimization and caching strategies"
      },
      {
        name: "Code Quality Assessment",
        input: "Review this Python API for code quality and maintainability",
        expectedOutput: "Should provide detailed code quality metrics and improvement suggestions"
      }
    ]),
    collaborators: JSON.stringify(["security-team@company.com", "dev-team@company.com", "qa-team@company.com"]),
    status: "active"
  },
  {
    name: "AI Content Generation Pipeline",
    description: "End-to-end content creation system with AI agents for research, writing, editing, and multimedia generation",
    agentConfig: JSON.stringify({
    ...
    testCases: JSON.stringify([
      {
        ...
        expectedOutput: "Should produce well-researched, engaging content with proper structure"
      },
      {
        name: "Social Media Content",
        input: "Create social media posts for the blog article",
        expectedOutput: "Should generate platform-specific content (Twitter, LinkedIn, Instagram)"
      }
    ]),
    collaborators: JSON.stringify(["content-team@company.com", "marketing@company.com", "design@company.com"]),
    status: "active"
  },
  {
    name: "Machine Learning Model Development",
    description: "Complete ML pipeline with data preprocessing, model training, evaluation, and deployment automation",
    agentConfig: JSON.stringify({
      model: "claude-3-5-sonnet-20241022",
      parameters: {
        temperature: 0.4,
    ...
    testCases: JSON.stringify([
      {
        ...
        expectedOutput: "Should provide data insights, feature engineering suggestions, and model recommendations"
      },
      {
        name: "Model Deployment",
        input: "Generate deployment code for the trained model",
        expectedOutput: "Should create production-ready API with proper error handling and monitoring"
      }
    ]),
    collaborators: JSON.stringify(["ml-team@company.com", "data-team@company.com", "devops@company.com"]),
    status: "planning"
  },
  {
    name: "API Integration and Testing Suite",
    description: "Comprehensive API development, testing, and integration system with automated documentation and client generation",
    agentConfig: JSON.stringify({
      model: "claude-3-5-sonnet-20241022",
      parameters: {
        temperature: 0.6,
    ...
    testCases: JSON.stringify([
      {
        ...
        expectedOutput: "Should create complete OpenAPI 3.0 specification with examples"
      },
      {
        name: "Test Coverage",
        input: "Create comprehensive test suite for authentication endpoints",
        expectedOutput: "Should generate unit tests, integration tests, and load tests"
      }
    ]),
    collaborators: JSON.stringify(["backend-team@company.com", "frontend-team@company.com", "qa-team@company.com"]),
    status: "in_progress"
  },
  {
    name: "Real-time Data Dashboard",
    description: "Interactive dashboard with real-time data visualization, alerts, and automated report generation",
    agentConfig: JSON.stringify({
      model: "gpt-4o-2024-11-20",
      parameters: {
        temperature: 0.5,
    ...
    testCases: JSON.stringify([
      {
        ...
        expectedOutput: "Should handle connection management, data synchronization, and error recovery"
      },
      {
        name: "Report Generation",
        input: "Create automated weekly report generation system",
        expectedOutput: "Should generate PDF reports with charts, insights, and recommendations"
      }
    ]),
    collaborators: JSON.stringify(["analytics@company.com", "product@company.com", "executive@company.com"]),
    status: "active"
  },
  {
    name: "Voice Assistant Development",
    description: "Advanced voice assistant with natural language understanding, speech synthesis, and contextual awareness",
    agentConfig: JSON.stringify({
      model: "claude-3-5-sonnet-20241022",
      parameters: {
        temperature: 0.7,
    ...
    testCases: JSON.stringify([
      {
        ...
        expectedOutput: "Should accurately transcribe various accents and speaking styles"
      },
      {
        name: "Contextual Responses",
        input: "Generate contextually appropriate responses to user queries",
        expectedOutput: "Should maintain conversation context and provide relevant, helpful responses"
      }
    ]),
    collaborators: JSON.stringify(["ai-team@company.com", "ux-team@company.com", "linguistics@company.com"]),
    status: "planning"
  }
];
