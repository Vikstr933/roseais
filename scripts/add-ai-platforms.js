...
const aiPlatformsData = [
  {
    name: 'Hugging Face',
    description:
      'The AI community building the future. Open-source AI models, datasets, and applications with a collaborative platform.',
    founded: '2016',
  ...
  },
  {
    name: 'Replicate',
    description:
      'Run machine learning models in the cloud. Simple API to run open-source models with one line of code.',
    founded: '2019',
  ...
  },
  {
    name: 'Stability AI',
    description:
      'Building open AI tools that benefit all of humanity. Creators of Stable Diffusion and other generative AI models.',
    founded: '2020',
  ...
  },
  {
    name: 'Runway ML',
    description:
      'Applied AI research company building the next generation of creative tools for artists and creators.',
    founded: '2018',
  ...
  },
  {
    name: 'Midjourney',
    description:
      'AI-powered image generation platform creating stunning visuals from text descriptions.',
    founded: '2022',
  ...
  },
  {
    name: 'Civitai',
    description:
      'Open-source AI community platform for sharing and discovering AI models, with focus on Stable Diffusion.',
    founded: '2022',
  ...
  },
  {
    name: 'EleutherAI',
    description:
      'Open-source AI research collective focused on understanding and developing large language models.',
    founded: '2020',
  ...
  },
  {
    name: 'LAION',
    description:
      'Large-scale AI Open Network - Non-profit organization providing large-scale datasets for AI research.',
    founded: '2020',
